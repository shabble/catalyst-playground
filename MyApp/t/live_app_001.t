...
$ua1->get_ok("http://localhost/login?uname=test01&password=mypass", "Login 'test01'");
...
# Log back in
$ua1->get_ok("http://localhost/login?uname=test01&password=mypass",
             "Login 'test01'");

$ua2->get_ok("http://localhost/login?uname=test02&password=mypass",
             "Login 'test02'");
